...
# Dark VPN / V2Dark (FlyD) — gem-panel first; live CDN mirrors if API blocks (e.g. GHA 403).
...
def fetch_dv_wrapper() -> dict:
    """Fetch DarkVPN app-data: live gem-panel, then live CDN mirrors (not local cache)."""
    sources = [
        (
            "gem-panel",
            DV_API_URL,
